...
import { Button, Modal, Row, Col, Input, Container } from "reactstrap";
    ...
    <div>
      ...
      <Container>
        <Modal isOpen={modal} toggle={toggle} size="lg">
          <Row>
            <Col
              style={{ height: "75vh", backgroundColor: "#6946CD" }}
              sm="12"
              xs="6"
              md="6"
            >
            ...
            <Col sm="12" xs="6" md="6">
              ...
              <Row style={{ marginTop: "30px", marginLeft: "10px" }}>
                ...
                <div style={{ marginTop: "80px" }}>
                  ...
                  >
                    By Sign in to create an account I accept Badhahi Raajje
                    Online
                    <br />
